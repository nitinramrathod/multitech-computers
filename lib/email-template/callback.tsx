...
export const CallbackEmailTemplate = (data:DataTypes) => {
...
<body style="margin:0;padding:0;background-color:#f1f5f9;font-family:'Segoe UI', 'Helvetica Neue', Arial, sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f1f5f9;padding:40px 16px;">
    <tr><td align="center">
                ...
                <td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0"><tr>
                    <td style="width:60px;vertical-align:middle;">
                      <div style="width:48px;height:48px;background:rgba(59,130,246,0.2);border:1px solid rgba(59,130,246,0.4);border-radius:12px;text-align:center;line-height:48px;font-size:22px;">📞</div>
                    </td>
                    <td style="vertical-align:middle;">
                      <h1 style="margin:0 0 4px;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:-0.3px;">New Callback Request</h1>
                      <p style="margin:0;color:#93c5fd;font-size:13px;">A customer wants you to call them back</p>
                    </td>
                  </tr></table>
                </td>
                <td valign="top" align="right">
                  <span style="display:inline-block;background:#10b981;color:#fff;font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;padding:5px 12px;border-radius:20px;">Callback</span>
                </td>
              </tr>
            </table>
          </td>
      ...
      <p style="margin:20px 0 6px;font-size:13px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:1.5px;">Caller Details</p>
  <div style="height:2px;background:linear-gradient(90deg,#3b82f6,transparent);margin-bottom:14px;border-radius:2px;"></div>
    ...
    <tr><td style="padding:12px 16px;background:#eff6ff;border-radius:8px;border-left:3px solid #3b82f6;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px;">
    <tr><td style="padding:12px 16px;background:#eff6ff;border-radius:8px;border-left:3px solid #3b82f6;">
      <span style="display:block;font-size:11px;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">Reason</span>
      <span style="display:block;font-size:15px;font-weight:500;color:#0f172a;word-break:break-word;">${data.reason}</span>
    </td></tr>
  </table>
      <div style="margin-top:20px;background:linear-gradient(135deg,#eff6ff,#dbeafe);border:1px solid #bfdbfe;border-radius:10px;padding:16px 20px;">
        <p style="margin:0;font-size:13px;font-weight:600;color:#1d4ed8;">📞 Action Required</p>
        <p style="margin:6px 0 0;font-size:13px;color:#3b82f6;">A customer has requested a callback. Please call <strong>Nitin Rathod</strong> at <strong>8459556244</strong> at the earliest convenience.</p>
      </div></td></tr>
        <!-- FOOTER -->
        <tr>
