...
export const ProductEnquiryEmailTemplate = (data:DataTypes) => {
  return (
    `
    <html lang="en">
<head>
...
<body style="margin:0;padding:0;background-color:#f1f5f9;font-family:'Segoe UI', 'Helvetica Neue', Arial, sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f1f5f9;padding:40px 16px;">
    <tr><td align="center">
                ...
                <td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0"><tr>
                    ...
                    <td style="vertical-align:middle;">
                      <h1 style="margin:0 0 4px;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:-0.3px;">New Product Enquiry</h1>
                      <p style="margin:0;color:#93c5fd;font-size:13px;">Enquiry received for ${data.productName}</p>
                    </td>
                  </tr></table>
                </td>
                <td valign="top" align="right">
                  <span style="display:inline-block;background:#3b82f6;color:#fff;font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;padding:5px 12px;border-radius:20px;">Enquiry</span>
                </td>
              </tr>
            </table>
          </td>
      ...
      <p style="margin:20px 0 6px;font-size:13px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:1.5px;">Product Information</p>
  <div style="height:2px;background:linear-gradient(90deg,#3b82f6,transparent);margin-bottom:14px;border-radius:2px;"></div>
      <div style="padding:16px 20px;background:linear-gradient(135deg,#0f172a,#1e3a5f);border-radius:10px;margin-bottom:16px;">
        <span style="display:block;font-size:11px;font-weight:700;color:#93c5fd;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:6px;">Product</span>
        <span style="display:block;font-size:16px;font-weight:700;color:#ffffff;">${data.productName}</span>
        <span style="display:inline-block;margin-top:6px;background:rgba(59,130,246,0.25);border:1px solid rgba(59,130,246,0.4);color:#93c5fd;font-size:12px;font-weight:600;padding:3px 10px;border-radius:20px;">${data.productCode}</span>
      </div>
      <p style="margin:20px 0 6px;font-size:13px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:1.5px;">Customer Details</p>
  <div style="height:2px;background:linear-gradient(90deg,#3b82f6,transparent);margin-bottom:14px;border-radius:2px;"></div>
  ...
  <div style="height:2px;background:linear-gradient(90deg,#3b82f6,transparent);margin-bottom:14px;border-radius:2px;"></div>
      <div style="padding:16px 20px;background:#f8fafc;border-radius:10px;border-left:3px solid #3b82f6;">
        <p style="margin:0;font-size:14px;color:#334155;line-height:1.7;font-style:italic;">"${data.message}"</p>
      </div></td></tr>
        <!-- FOOTER -->
        <tr>
